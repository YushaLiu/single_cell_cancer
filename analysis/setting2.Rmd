---
title: "Application of flash to simulated data (setting 2)"
author: "Yusha Liu"
date: "2022-4-25"
...
### simulate data which come from 3 groups, where group 1 further consists of 3 subgroups
set.seed(1)

### simulate loadings
L <- matrix(0, nrow=800, ncol=7)
L[,1] <- 1
L[1:600,2] <- 1
L[1:200,3] <- 1
L[201:400,4] <- 1
...
### simulate factors 
F <- matrix(0, nrow=1200, ncol=7)
F[,1] <- rnorm(1200, 20, 2)
F[1:200,2] <- rnorm(200, 0, 1)
F[201:300,3] <- rnorm(100, 0, 1)
F[301:400,4] <- rnorm(100, 0, 1)
F[401:500,5] <- rnorm(100, 0, 1)
F[501:550,6] <- rnorm(50, 0, 1)
F[551:600,7] <- rnorm(50, 0, 1)
...
fit.cov.v1 <- readRDS("output/setting2_iter1_cov.rds")
...
fit.cov <- readRDS("output/setting2_iter1_cov_binary.rds")
...
### fit NN to data matrix
fit.nn <- readRDS("output/setting2_iter2_nn.rds")
plotLF_data(fit.nn, title=c("Estimated L from NN to data", "Estimated F from NN to data"))

### fit SNN to data matrix
fit.snn <- readRDS("output/setting2_iter2_snn.rds")
plotLF_data(fit.snn, title=c("Estimated L from SNN to data", "Estimated F from SNN to data"))

### fit NN to covariance matrix with point exponential prior
fit.cov.v1 <- readRDS("output/setting2_iter2_cov.rds")
plotLF_cov(fit.cov.v1, title=c("Estimated L from SNN to covariance \n with point exponential prior", "Estimated F from SNN to covariance \n with point exponential prior"))

### fit NN to covariance matrix with generalized binary prior
fit.cov <- readRDS("output/setting2_iter2_cov_binary.rds")
plotLF_cov(fit.cov, title=c("Estimated L from SNN to covariance \n with general binary prior", "Estimated F from SNN to covariance \n with general binary prior"))
...
### fit NN to data matrix
fit.nn <- readRDS("output/setting2_iter3_nn.rds")
plotLF_data(fit.nn, title=c("Estimated L from NN to data", "Estimated F from NN to data"))

### fit SNN to data matrix
fit.snn <- readRDS("output/setting2_iter3_snn.rds")
plotLF_data(fit.snn, title=c("Estimated L from SNN to data", "Estimated F from SNN to data"))

### fit NN to covariance matrix with point exponential prior
fit.cov.v1 <- readRDS("output/setting2_iter3_cov.rds")
plotLF_cov(fit.cov.v1, title=c("Estimated L from SNN to covariance \n with point exponential prior", "Estimated F from SNN to covariance \n with point exponential prior"))

### fit NN to covariance matrix with generalized binary prior
fit.cov <- readRDS("output/setting2_iter3_cov_binary.rds")
plotLF_cov(fit.cov, title=c("Estimated L from SNN to covariance \n with general binary prior", "Estimated F from SNN to covariance \n with general binary prior"))
