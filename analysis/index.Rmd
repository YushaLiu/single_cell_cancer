...
Click on this [link](setting1.html) to see application of flash to simulated data which come from three groups, with two groups sharing similarity. <br /> 
Click on this [link](setting2.html) to see application of flash to simulated data which come from 3 groups, where group 1 further consists of 3 subgroups. <br /> 