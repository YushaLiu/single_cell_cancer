...
for(rep in 1:10){
  ...
  saveRDS(fit1, paste0("output/simulations3_more_XXt_fit1_sigma_05_rep", rep, ".rds"))
  ...
  saveRDS(fit2, paste0("output/simulations3_more_XXt_fit2_sigma_05_rep", rep, ".rds"))
  ...
  saveRDS(fit3, paste0("output/simulations3_more_XXt_fit3_sigma_05_rep", rep, ".rds"))
}
